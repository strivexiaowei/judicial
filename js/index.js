...
$(function () {
  var tebdata = [
    { 'pic1':'./images/txtlogo.png','pic2':'./images/txtlogo1.png'},
    { 'pic1':'./images/mvlogo.png','pic2':'./images/mvlogo2.png'},
    { 'pic1':'./images/piclogo.png','pic2':'./images/piclogo3.png'}
  ]
...
$(function () {
  ...
  data.forEach(function (e, i) {
    // console.log(e);
    $(`<li class="pic-items"><img  src="${e.img}" alt="">
           <p>${e.text}</p>
    ...
    $(` <img src="${e.img}">`).appendTo('.point-box')
  })
  var count = 0;
  ...
  $('.arrow-right').on('click', function () {
    ...
    $('.point-box img').eq(count).addClass('active').siblings().removeClass('active')
    if (count>4) {
      $('.point-box').stop().animate({left:-(count-4)*120})
    }else {
      $('.point-box').stop().animate({left:0})
    }
